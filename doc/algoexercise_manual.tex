...
\begin{document}
    ...
    % \begin{noindent}
        \begin{table}[ht] \centering
            \begin{tabular}{cccl} 
                ...
                wvfrage & grayInfoBox & 0~Punkte &  Wichtige~Verständnisfrage \\
                ...
                wvfragen & grayInfoBox & 0~Punkte &  Wichtige~Verständnisfragen \\
                ...
                kaufgabe & defBox & \{\} &  Konkrete~Aufgabe \\
                \bottomrule
            \end{tabular}
    ...
    \vspace{-2.5em}
    Ein Aufruf sind dann z.B. so aus: \vspace{-2cm} \vspace{\fill}
    \begin{figure}[ht!
        ]
        \centering
