...
% \titlegraphic*{\includegraphics{example-image-a}}
...
\begin{document}
    ...
    \begin{frame}[fragile,c]
        \slidehead{}
        \begin{codeBlock}[]{title=\codeBlockTitle{Java-Example},top=0cm,bottom=0cm}
        package com.example;
    ...
    \begin{frame}[fragile,c]
        \slidehead{}
        \begin{codeBlock}[]{minted language=racket,title=\codeBlockTitle{Racket-Example},top=0cm,bottom=0cm}
        ;; Type: real -> real
